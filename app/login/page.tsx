...
export default function LoginPage() {
    ...
    const { login, register, loginWithGoogle, isLoading: authLoading, isAuthenticated } = useAuth();
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            // Note: This will redirect to Google, so we don't need to handle success here
        } catch (err) {
